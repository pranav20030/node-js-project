...
const refreshAccessToken = asyncHandler(async(req, res) =>{
  const incommingRefreshToken =  req.cookies.refreshToken || re1.body.refreshToken

  if(!incommingRefreshToken){
    throw new ApiError(401, "unauthorizxed request")
  }
...
const updateAccountDetails = asyncHandler(async(req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, user, "Account Details is updated successfully"))
})
